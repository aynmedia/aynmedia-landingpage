...
import Website from '../../public/images/Website-Ayntech.webp';
import Googole from '../../public/images/Googole_partner.webp';
import Meta from '../../public/images/Meta-partner.webp';
import Google from '../../public/images/Goggle_Icon.webp';
const date = new Date();
...
const Footer = () => {
  return (
    <footer className=' bg-primary'>
      <section>
        <div className='bg-primary bgfont2 p-5'>
          <div>
            <div className='flex flex-wrap md:flex-nowrap justify-around'>
              ...
              <div className='bg-[#160003] p-5 lg:p-10 w-full md:w-1/2 lg:w-1/4 mt-10 lg:mt-0'>
        ...
        {/* Copyright Section */}
        <div className='text-center py-4 text-white bg-primary'>
